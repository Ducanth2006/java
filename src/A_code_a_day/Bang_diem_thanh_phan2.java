...
class student6 {
    ...
    public student6(String id, String name, String lop, double s1, double s2, double s3) {
        this.id = id;
        this.name = name;
        this.lop = lop;
        this.s1 = s1;
...
public class Bang_diem_thanh_phan2 {
    public static void main(String[] args) {
        ...
        ArrayList<student6> ds = new ArrayList<>();
        ...
        for (int i = 1; i <= test; i++) {
            ...
            ds.add(new student6(id, name, lop, s1, s2, s3));

        }
        ds.sort(Comparator.comparing(student6::getName));
        int stt = 1;
        for (student6 x : ds) {
